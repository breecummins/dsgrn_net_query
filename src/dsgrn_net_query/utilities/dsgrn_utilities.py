def satisfies_hex_constraints(param, hex_constraints):
    '''
    Checks if a DSGRN parameter satisfies user-supplied DSGRN hex constraints.
    :param param: A DSGRN.Parameter object
    :param hex_constraints: a dictionary of lists keying a tuple of two integers to a list of hex numbers.
